...
extern "C" void executeGraph(
  ...
  float* intermediate_1_data = (float*)allocator.allocate(131072);
  ...
  float* intermediate_2_data = (float*)allocator.allocate(131072);
  ...
  float* intermediate_3_data = (float*)allocator.allocate(131072);
  ...
  float* intermediate_4_data = (float*)allocator.allocate(131072);
  ...
  float* intermediate_5_data = (float*)allocator.allocate(131072);
  ...
  float* intermediate_6_data = (float*)allocator.allocate(131072);
  ...
  float* intermediate_7_data = (float*)allocator.allocate(131072);
  ...
  float* intermediate_8_data = (float*)allocator.allocate(1048576);
  ...
  float* intermediate_13_data = (float*)allocator.allocate(131072);
  ...
  positional_encoding_forward<<<dim3(1, 256, 1), dim3(256, 1, 1), 0>>>(intermediate_1_tensor, intermediate_0_tensor, param_1_frequencies);
  CUDA_CHECK(cudaGetLastError());
  dense_forward_3d<<<dim3(1, 256, 1), dim3(256, 1, 1), 0>>>(intermediate_2_tensor, intermediate_1_tensor, param_2_weights, param_3_bias);
  CUDA_CHECK(cudaGetLastError());
  dense_forward_3d<<<dim3(1, 256, 1), dim3(256, 1, 1), 0>>>(intermediate_3_tensor, intermediate_1_tensor, param_4_weights, param_5_bias);
  CUDA_CHECK(cudaGetLastError());
  dense_forward_3d<<<dim3(1, 256, 1), dim3(256, 1, 1), 0>>>(intermediate_4_tensor, intermediate_1_tensor, param_6_weights, param_7_bias);
  CUDA_CHECK(cudaGetLastError());
